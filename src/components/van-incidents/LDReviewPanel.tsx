...
import { 
  ...
  AlertCircle, DollarSign, Car, MapPin, Calendar, Clock, User
} from "lucide-react";
      ...
      <div className="flex justify-end gap-2 pt-4 border-t">
        ...
        {!isAlreadyReviewed && (
          <Button
            ...
            disabled={ldReview.isPending || (reviewStatus === "needs_revision" && !comment.trim())}
          >
            {ldReview.isPending ? <Loader2 className="h-4 w-4 mr-1 animate-spin" /> : <CheckCircle className="h-4 w-4 mr-1" />}
            Submit Review
          </Button>
        )}
      </div>
